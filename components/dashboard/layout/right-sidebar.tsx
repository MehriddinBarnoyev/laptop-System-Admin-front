...
import { CircleOff, Download, Lock, Radio, RefreshCw, Shield, Terminal, Zap } from "lucide-react"
import ActionButton from "@/components/dashboard/ui/action-button"
import { formatTime, formatDate } from "@/lib/utils"

export default function RightSidebar() {
  const { currentTime, cpuUsage, memoryUsage, networkStatus, rawData } = useDashboard()
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="text-xs text-cyan-400">{Math.round(cpuUsage)}% allocated</div>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="text-xs text-purple-400">{Math.round(memoryUsage)}% allocated</div>
                </div>
                <div className="h-2 bg-slate-800 rounded-full overflow-hidden">
                  <div
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="text-xs text-blue-400">{Math.round(networkStatus)}% allocated</div>
                </div>
                <div className="h-2 bg-slate-800 rounded-full overflow-hidden">
                  <div
...
// Helper function to format uptime in days, hours, minutes, seconds
function formatUptime(seconds: number): string {
  ...
  return `${days}d ${hours.toString().padStart(2, "0")}:${minutes.toString().padStart(2, "0")}:${Math.floor(seconds).toString().padStart(2, "0")}`
}
