...
import StorageItem from "@/components/ui/storage-item"
...
export default function SystemOverview({ cpuUsage, memoryUsage, networkStatus, systemStatus }: SystemOverviewProps) {
  return (
